...
export const Route = createFileRoute("/apply-now")({
  head: () => ({
    meta: [
      { title: "Apply Now — Start Your Study-Abroad Journey Today" },
      { name: "description", content: "Begin your application with Find My Career. Tell us your goals and an advisor will reach out within 24 hours." },
      { property: "og:title", content: "Apply Now — Find My Career" },
      { property: "og:description", content: "Start your application today. Free consultation, expert guidance." },
      { property: "og:url", content: "/apply-now" },
    ],
    links: [{ rel: "canonical", href: "/apply-now" }],
  }),
  component: Apply,
});
