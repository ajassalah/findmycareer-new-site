...
export const Route = createFileRoute("/scholarship-guidance")({
  head: () => ({
    meta: [
      { title: "Scholarship Guidance — Find My Career" },
      { name: "description", content: "Maximize your opportunities with expert scholarship guidance. We help students identify, apply for, and secure scholarships worldwide." },
    ],
    links: [{ rel: "canonical", href: "/scholarship-guidance" }],
  }),
  component: ScholarshipGuidancePage,
});
