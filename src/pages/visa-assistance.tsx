          ...
          >
            <div className="grid lg:grid-cols-2 gap-0">
              <div className="p-8 lg:p-10 flex flex-col justify-between">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link href="/innovator-founder-visa" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#0A1628] text-white font-semibold text-sm hover:scale-105 active:scale-95 transition-transform shadow-md">
