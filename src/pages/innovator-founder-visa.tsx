...
const contactHref = (params: Record<string, string>) => `/contact?${new URLSearchParams(params).toString()}`;
...
export default function InnovatorFounderVisaPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.div variants={fadeUp} className="flex flex-wrap gap-3 pt-2">
                <Link
                  href={contactHref({ interestedIn: "Innovator Founder Visa" })}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto items-center">
            ...
            >
              ...
              <div className="mt-6">
                <Link
                  href={contactHref({ interestedIn: "Innovator Founder Visa - Essential Package", message: "Hi, I am interested in the Essential Package for the Innovator Founder Visa." })}
            ...
            >
              ...
              <div className="mt-6">
                <Link
                  href={contactHref({ interestedIn: "Innovator Founder Visa - Professional Package", message: "Hi, I am interested in the Professional Package for the Innovator Founder Visa." })}
            ...
            >
              ...
              <div className="mt-6">
                <Link
                  href={contactHref({ interestedIn: "Innovator Founder Visa - Premium Package", message: "Hi, I am interested in the Premium Package for the Innovator Founder Visa." })}
